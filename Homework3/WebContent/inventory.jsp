...
<br/>
	...
	<a href="<c:url value='http://localhost:8080/Lab4/admin/foods/create' />"
	
		class="button">Add new Food</a> </main>
		</br>
		
		<a href="<c:url value='http://localhost:8080/Lab4/admin/orders' />"
	
		class="button">Manage the order</a> </main>
		</br>
		
	
		<a href="<c:url value='http://localhost:8080/Lab4/menu' />"
