...
public class Food extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("</br>");
		out.println("<a href='http://localhost:8080/Homework2/menu'>Check your Menu</a>");
		out.println("</br>");
		out.println("<a href='http://localhost:8080/Homework2/admin/orders'>Manage your order</a>");
		out.println("</br>");
		out.println("</br>");
